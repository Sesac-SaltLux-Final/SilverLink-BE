...
class AccessRequestControllerTest {
                ...
                void getMyRequests_Success() throws Exception {
                        ...
                        List<AccessRequestSummary> responses = List.of(
                                        new AccessRequestSummary(100L, "김보호", "박어르신", "HEALTH_INFO", "건강정보",
                                                        "PENDING", "대기중", false, LocalDateTime.now(), null, null, null,
                                                        false),
                                        new AccessRequestSummary(101L, "김보호", "박어르신", "MEDICATION", "복약정보",
                                                        "APPROVED", "승인됨", true, LocalDateTime.now().minusDays(10),
                                                        null, null, null,
                                                        true));
        ...
        class AdminApiTest {
                ...
                void getPendingRequests_Success() throws Exception {
                        // given
                        List<AccessRequestSummary> responses = List.of(
                                        new AccessRequestSummary(1L, "보호자1", "어르신1", "CALL_RECORDS",
                                                        "통화기록", "PENDING", "대기중", false, LocalDateTime.now(), null,
                                                        null, null, false),
                                        new AccessRequestSummary(2L, "보호자2", "어르신2", "MEDICATION",
                                                        "복약정보", "PENDING", "대기중", false,
        ...
        class ElderlyApiTest {
                ...
                void getRequestsForMe_Success() throws Exception {
                        List<AccessRequestSummary> responses = List.of(
                                        new AccessRequestSummary(100L, "김보호", "박어르신", "HEALTH_INFO", "건강정보",
                                                        "APPROVED", "승인됨", true, LocalDateTime.now().minusDays(30),
                                                        null, null, null,
                                                        true));
        ...
        class CheckAccessApiTest {
                ...
                void checkAccess_HasAccess() throws Exception {
                        AccessCheckResult result = new AccessCheckResult(
                                        true, "HEALTH_INFO", LocalDateTime.now().minusDays(30),
                                        LocalDateTime.now().plusMonths(11), "접근 권한이 있습니다.");
                        given(accessRequestService.checkAccess(4L, 2L, AccessScope.HEALTH_INFO)).willReturn(result);
                        mockMvc.perform(get("/api/access-requests/check").param("elderlyUserId", "2").param("scope",
                                        "HEALTH_INFO"))
                                        .andExpect(status().isOk());
                }
        ...
        class ValidationTest {
                ...
                void createRequest_Validation_ElderlyUserIdNull() throws Exception {
                        ...
                        mockMvc.perform(post("/api/access-requests").with(csrf())
                ...
                void rejectRequest_Validation_ReasonRequired() throws Exception {
                        ...
                        mockMvc.perform(post("/api/access-requests/100/reject").with(csrf())
                                        .contentType(MediaType.APPLICATION_JSON).content(invalidRequest))
                                        .andExpect(status().isBadRequest());
                }
        }
