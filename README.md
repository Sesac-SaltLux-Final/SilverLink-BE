...
**SilverLink** 프로젝트의 백엔드 서비스입니다. 시니어/독거노인을 위한 AI 기반 콜봇(AICC) 및 챗봇 모니터링 플랫폼의 핵심 비즈니스 로직과 데이터 관리를 담당합니다.
...
```text
SilverLink-BE/
├── .github/                        # GitHub Actions 설정 (CI/CD 파이프라인)
